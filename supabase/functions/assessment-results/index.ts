...
function getDimensionRecommendations(dimension: string, level: number): string {
  const recommendations: Record<string, Record<number, string>> = {
    "Liderança": {
      ...
      6: "Transforme radicalmente o paradigma de liderança global através da criação de modelos revolucionários que redefinam como as organizações são lideradas no século XXI. Desenvolva e implemente metodologias de liderança quântica que integrem inteligência artificial, neurociência e psicologia comportamental para criar líderes extraordinários capazes de navegar em complexidades inimagináveis. Estabeleça ecossistemas de liderança interconectados que transcendam fronteiras organizacionais, setoriais e geográficas, criando redes globais de influência positiva. Torne-se o arquiteto do futuro da liderança, desenvolvendo teorias e práticas que sejam estudadas e adotadas mundialmente, posicionando a organização como a definidora dos padrões de excelência em liderança para as próximas gerações."
    },
    "Estratégias e Planos": {
      ...
      6: "Redefina o futuro dos negócios através da criação de estratégias revolucionárias que transformem indústrias inteiras e estabeleçam novos paradigmas econômicos globais. Desenvolva capacidades de planejamento quântico que utilizem inteligência artificial avançada, modelagem de complexidade e análise de sistemas adaptativos para antecipar e moldar o futuro dos mercados. Estabeleça ecossistemas estratégicos planetários que integrem sustentabilidade regenerativa, inovação disruptiva e impacto social transformador em escala global. Torne-se o arquiteto de um novo modelo de capitalismo consciente, criando frameworks estratégicos que sejam adotados por organizações, governos e instituições multilaterais como o padrão para o desenvolvimento sustentável da humanidade."
    },
    "Processos": {
      ...
      6: "Transforme radicalmente a indústria através da criação de processos disruptivos que redefinam padrões globais de excelência operacional e sirvam como modelo para organizações em todo o mundo. Lidere a revolução digital dos processos através da implementação de tecnologias emergentes como inteligência artificial quântica, automação cognitiva e sistemas adaptativos que antecipem e respondam automaticamente às mudanças do mercado. Estabeleça ecossistemas de processos interconectados que transcendam os limites organizacionais, criando redes de valor que beneficiem toda a cadeia produtiva e a sociedade. Desenvolva metodologias proprietárias de gestão de processos que sejam estudadas e adotadas globalmente, posicionando a organização como pioneira na definição do futuro da excelência operacional."
    },
    "Pessoas": {
      ...
      6: "Revolucione o futuro do trabalho e do desenvolvimento humano através da criação de modelos organizacionais que maximizem o potencial humano e estabeleçam novos padrões globais de bem-estar e realização profissional. Desenvolva tecnologias de enhancement humano que integrem inteligência artificial, biotecnologia e neurociência para criar experiências de trabalho transcendentais que elevem a consciência e capacidades humanas. Estabeleça ecossistemas de desenvolvimento humano que conectem organizações globalmente, criando uma rede planetária de evolução coletiva e crescimento pessoal. Torne-se o pioneiro de uma nova era de relações humanas no trabalho, desenvolvendo filosofias e práticas que sejam estudadas e implementadas mundialmente como o futuro da experiência humana organizacional."
    },
    "Clientes": {
      ...
      6: "Transcenda os limites tradicionais da experiência do cliente criando realidades imersivas que transformem fundamentalmente como os seres humanos interagem com produtos, serviços e marcas no universo digital e físico. Desenvolva experiências sensoriais e emocionais revolucionárias que utilizem realidade aumentada, inteligência artificial empática e interfaces neurais para criar conexões que vão além do comercial, tocando a alma humana. Estabeleça ecossistemas de experiência planetários que conectem clientes globalmente em comunidades transformadoras de valor compartilhado e crescimento mútuo. Torne-se o arquiteto de uma nova dimensão de relacionamento humano-marca, criando paradigmas experienciais que sejam estudados e replicados como o futuro da conexão entre organizações e sociedade."
    },
    "Resultados": {
      ...
      6: "Redefina o conceito global de sucesso organizacional através da criação de modelos de valor que transcendam métricas tradicionais e estabeleçam novos paradigmas de prosperidade planetária e bem-estar coletivo. Desenvolva sistemas de mensuração quântica que integrem impacto multidimensional, incluindo regeneração ecológica, evolução social, desenvolvimento espiritual e abundância compartilhada em escala global. Estabeleça redes de valor interconectadas que transformem a economia mundial em um sistema regenerativo onde o sucesso de uma organização amplifica automaticamente o bem-estar de toda a humanidade e do planeta. Torne-se o pioneiro de uma nova era de resultados organizacionais, criando frameworks de valor que sejam adotados por governos, organizações multilaterais e corporações como o padrão para medir o verdadeiro progresso da civilização humana."
    },
    "Sociedade": {
