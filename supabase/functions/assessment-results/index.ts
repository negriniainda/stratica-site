...
function getDimensionRecommendations(dimension: string, level: number): string {
  const recommendations: Record<string, Record<number, string>> = {
    ...
    "Processos": {
      1: "Comece identificando e mapeando os processos mais críticos da organização através de workshops com as equipes operacionais, documentando fluxos básicos de trabalho e identificando gargalos evidentes. Estabeleça procedimentos operacionais padrão (POPs) simples para as atividades mais importantes, garantindo que sejam compreensíveis e aplicáveis no dia a dia. Implemente controles básicos de qualidade através de checklists e verificações simples que previnam erros recorrentes. Crie reuniões semanais de melhoria com as equipes para discutir problemas operacionais e implementar soluções rápidas.",
      2: "Desenvolva um sistema formal de gestão de processos com mapeamento detalhado utilizando ferramentas como fluxogramas e SIPOC, estabelecendo responsabilidades claras e tempos padrão para cada atividade. Implemente indicadores básicos de performance (KPIs) para monitorar eficiência, qualidade e produtividade dos principais processos organizacionais. Estabeleça procedimentos estruturados de melhoria contínua baseados no ciclo PDCA e crie sistemas de feedback regular das equipes. Desenvolva treinamentos padronizados para garantir que todos os colaboradores compreendam e sigam os processos estabelecidos.",
      3: "Implemente metodologias avançadas de melhoria de processos como Lean Manufacturing, eliminando desperdícios e otimizando fluxos de valor através de técnicas como mapeamento de fluxo de valor e kaizen. Estabeleça sistemas robustos de gestão da qualidade baseados em normas como ISO 9001, implementando controles estatísticos de processo e análise de causa raiz. Desenvolva dashboards de monitoramento em tempo real com indicadores leading e lagging que permitam tomada de decisão proativa. Crie grupos de melhoria multifuncionais e estabeleça um escritório de processos para coordenar iniciativas de otimização.",
      4: "Integre completamente a gestão de processos com a estratégia organizacional através de metodologias como BPM (Business Process Management) e implementação de tecnologias de automação de processos. Desenvolva capacidades avançadas de análise de dados e business intelligence para otimização contínua baseada em evidências quantitativas. Implemente práticas de gestão ágil de processos que permitam adaptação rápida a mudanças de mercado e necessidades dos clientes. Estabeleça centros de excelência operacional e programas de certificação interna em metodologias de melhoria.",
      5: "Pratique excelência operacional de classe mundial através da implementação de metodologias integradas como Lean Six Sigma, TPM (Total Productive Maintenance) e gestão por processos de ponta a ponta. Desenvolva capacidades superiores de inovação em processos utilizando tecnologias emergentes como automação inteligente, IoT e analytics preditivo. Estabeleça benchmarking sistemático com organizações líderes mundiais e implemente práticas de world-class manufacturing. Crie laboratórios de inovação em processos e estabeleça parcerias com universidades e centros de pesquisa para desenvolvimento de novas metodologias.",
      6: "Torne-se um benchmark reconhecido globalmente em excelência operacional, desenvolvendo metodologias proprietárias inovadoras que sejam estudadas e replicadas por outras organizações mundialmente. Influencie ativamente o desenvolvimento de novas práticas de gestão de processos através de liderança em associações profissionais e publicação de pesquisas relevantes. Estabeleça um centro de excelência que sirva como referência mundial em gestão de processos, oferecendo consultorias e treinamentos para outras organizações. Crie frameworks revolucionários que redefinam os padrões de excelência operacional e sejam adotados como melhores práticas globais."
    },
    "Pessoas": {
      1: "Estabeleça práticas básicas de gestão de pessoas começando com processos simples de recrutamento e seleção que identifiquem candidatos com perfil adequado para as funções disponíveis. Implemente programas básicos de integração (onboarding) que apresentem novos colaboradores à cultura, valores e procedimentos organizacionais. Crie descrições claras de cargos e responsabilidades para que todos compreendam suas atribuições e expectativas de performance. Estabeleça reuniões regulares entre gestores e colaboradores para acompanhamento de atividades e feedback básico sobre desempenho.",
      2: "Desenvolva um sistema formal de gestão de pessoas com políticas estruturadas de recrutamento, seleção e desenvolvimento que atraiam e retenham talentos alinhados com os objetivos organizacionais. Implemente programas de treinamento e capacitação que desenvolvam competências técnicas e comportamentais necessárias para o crescimento profissional. Estabeleça processos de avaliação de desempenho que incluam definição de metas, acompanhamento regular e feedback estruturado. Crie planos básicos de carreira e sucessão que motivem colaboradores e preparem a organização para mudanças futuras.",
      3: "Implemente práticas avançadas de gestão de talentos utilizando ferramentas de people analytics para tomada de decisões baseada em dados sobre recrutamento, desenvolvimento e retenção. Estabeleça programas robustos de desenvolvimento de liderança que preparem gestores para enfrentar desafios complexos e liderar equipes de alta performance. Desenvolva uma cultura organizacional forte baseada em valores compartilhados, comunicação transparente e reconhecimento de contribuições. Crie sistemas de gestão do conhecimento que capturem, compartilhem e apliquem o aprendizado organizacional de forma sistemática.",
      4: "Integre completamente a gestão de pessoas com a estratégia organizacional através de práticas de gestão de talentos que desenvolvam capacidades críticas para o sucesso futuro. Desenvolva programas avançados de employee experience que criem jornadas personalizadas e engajadoras para diferentes perfis de colaboradores. Implemente práticas de diversidade e inclusão que promovam um ambiente de trabalho equitativo e aproveitem diferentes perspectivas para inovação. Estabeleça sistemas de liderança distribuída que empoderem pessoas em todos os níveis a contribuir para resultados organizacionais.",
      5: "Pratique gestão de pessoas de classe mundial através da implementação de metodologias integradas que posicionem a organização como empregadora de escolha no mercado. Desenvolva capacidades superiores de inovação em práticas de RH utilizando tecnologias emergentes como inteligência artificial, analytics preditivo e automação inteligente. Estabeleça benchmarking sistemático com organizações líderes mundiais em gestão de pessoas e implemente as melhores práticas globais. Crie centros de excelência em gestão de talentos e estabeleça parcerias com universidades para desenvolvimento de novas metodologias.",
      6: "Torne-se um benchmark reconhecido globalmente em gestão de pessoas, desenvolvendo práticas proprietárias inovadoras que sejam estudadas e replicadas por outras organizações mundialmente. Influencie ativamente o desenvolvimento de novas práticas de gestão de talentos através de liderança em associações profissionais e publicação de pesquisas relevantes. Estabeleça um centro de excelência que sirva como referência mundial em gestão de pessoas, oferecendo consultorias e programas de desenvolvimento para outras organizações. Crie frameworks revolucionários que redefinam os padrões de employee experience e sejam adotados como melhores práticas globais."
    },
    "Clientes": {
    ...
    "Resultados": {
      1: "Estabeleça sistemas básicos de monitoramento de resultados implementando controles simples de receitas, custos e lucratividade que permitam acompanhar a performance financeira fundamental da organização. Monitore indicadores operacionais básicos como produtividade, qualidade e satisfação de clientes através de métricas simples e relatórios mensais. Implemente controles básicos de processos críticos e estabeleça reuniões regulares para análise de resultados. Crie registros sistemáticos de dados que permitam identificar tendências básicas de performance.",
      2: "Desenvolva um sistema estruturado de indicadores de performance (KPIs) que monitore resultados financeiros, operacionais, de clientes e pessoas de forma integrada e sistemática. Implemente dashboards básicos e relatórios gerenciais que forneçam visibilidade sobre o desempenho organizacional e suas tendências. Estabeleça metas específicas e mensuráveis para áreas críticas e crie processos de análise que identifiquem causas de desvios. Desenvolva capacidades básicas de benchmarking com concorrentes e melhores práticas do setor.",
      3: "Implemente um sistema abrangente de gestão de resultados utilizando metodologias como balanced scorecard que integrem perspectivas financeiras, operacionais, de clientes e aprendizado organizacional. Desenvolva capacidades de análise de dados e business intelligence que suportem tomada de decisões baseada em evidências. Estabeleça processos sistemáticos de benchmarking e análise competitiva. Crie cultura de melhoria contínua baseada em dados, resultados e aprendizado organizacional.",
      4: "Integre completamente a gestão de resultados com o planejamento estratégico através de sistemas avançados de performance management que utilizem analytics e tecnologias de business intelligence. Desenvolva capacidades de análise preditiva que antecipem tendências e identifiquem oportunidades de melhoria e crescimento. Implemente sistemas de monitoramento em tempo real que permitam ajustes rápidos de estratégias e operações. Estabeleça processos de gestão de riscos integrados com a gestão de resultados.",
      5: "Pratique gestão de resultados de classe mundial através da implementação de sistemas integrados de performance management que utilizem tecnologias avançadas de analytics, inteligência artificial e automação. Desenvolva capacidades superiores de business intelligence e analytics preditivo que otimizem resultados e criem vantagens competitivas sustentáveis. Estabeleça benchmarking sistemático com organizações líderes mundiais e implemente as melhores práticas globais. Crie centros de excelência em gestão de performance que sirvam como referência para outras organizações.",
      6: "Torne-se um benchmark reconhecido globalmente em gestão de resultados, desenvolvendo metodologias proprietárias inovadoras que sejam estudadas e replicadas por outras organizações mundialmente. Influencie ativamente o desenvolvimento de novas práticas de performance management através de liderança em associações profissionais e publicação de pesquisas relevantes. Estabeleça um centro de excelência que sirva como referência mundial em gestão de resultados, oferecendo consultorias e programas de desenvolvimento para outras organizações. Crie frameworks revolucionários que redefinam os padrões de gestão de performance e sejam adotados como melhores práticas globais."
    },
    "Sociedade": {
